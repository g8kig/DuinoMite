...
void initKeyboard(void) {
    ...
    // enable pull ups on the clock and data lines.  
    ...
    P_PS2CLK_PULLUP = P_ON; // turn on the pull up for pin D6 also called CN15
    P_PS2DAT_PULLUP = P_ON; // turn on the pull up for pin D7 also called CN16
